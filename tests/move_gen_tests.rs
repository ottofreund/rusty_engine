...
fn rook_sliding_bbs_are_correct() {
    ...
    let mut relevant_blockers: u64 = gen.get_relevant_blockers(rook_sqr as usize, blockers, true, false);
    let mut precomputed: u64 = gen.get_sliding_for(rook_sqr as usize, relevant_blockers, true, false, 0);
    ...
    relevant_blockers = gen.get_relevant_blockers(rook_sqr as usize, blockers, true, false);
    precomputed = gen.get_sliding_for(rook_sqr as usize, relevant_blockers, true, false, 0);
    assert_eq!(correct, precomputed);
    println!("With rook at sqr {}, got legal slides:\n{}", rook_sqr, bitboard::bb_to_string(precomputed));
    println!("NEW CASE \n");
    rook_sqr = 27;
...
fn bishop_sliding_bbs_are_correct() {
    ...
    let mut relevant_blockers: u64 = gen.get_relevant_blockers(bishop_sqr as usize, blockers, false, true);
    let mut precomputed: u64 = gen.get_sliding_for(bishop_sqr as usize, relevant_blockers, false, true, 0);
    println!("Correct:\n{}", bitboard::bb_to_string(correct));
    assert_eq!(correct, precomputed);
    ...
    relevant_blockers = gen.get_relevant_blockers(bishop_sqr as usize, blockers, false, true);
    precomputed = gen.get_sliding_for(bishop_sqr as usize, relevant_blockers, false, true, 0);
    assert_eq!(correct, precomputed);
    println!("With bishop at sqr {}, got legal slides:\n{}", bishop_sqr, bitboard::bb_to_string(precomputed));
    println!("NEW CASE \n");
    bishop_sqr = 28;
