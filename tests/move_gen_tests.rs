...
fn rook_sliding_bbs_are_correct() {
    ...
    let mut relevant_blockers: u64 = bitboard::get_relevant_blockers(rook_sqr, blockers, true, false, &gen);
    ...
    relevant_blockers = bitboard::get_relevant_blockers(rook_sqr, blockers, true, false, &gen);
...
fn bishop_sliding_bbs_are_correct() {
    ...
    let mut relevant_blockers: u64 = bitboard::get_relevant_blockers(bishop_sqr, blockers, false, true, &gen);
    ...
    relevant_blockers = bitboard::get_relevant_blockers(bishop_sqr, blockers, false, true, &gen);
